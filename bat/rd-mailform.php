...
try {
    ...
    if (isset($_POST['form-type'])) {
        switch ($_POST['form-type']){
            case 'contact':
                $subject = 'Wiadomość od użytkownika strony clxcinema';
                break;
            case 'subscribe':
    ...
    if ($formConfig['useSmtp']) {
        ...
        $mail->Username = $formConfig['formularz.clx@op.pl'];

        // Password to use for SMTP authentication
        $mail->Password = $formConfig['Formularz2021'];
    }
    ...
    if (isset($_POST['name'])){
        ...
        $mail->FromName = "Wiadomość ze strony clxcinema";
    }
